...
@pytest.mark.parametrize('message,expected', [
    ('Я потратил 7450 тенге', "Ты потратил 1000.0 рублей"),
    ('Я потратил 1000 тенге', "Ты потратил 134.23 рублей"),
    ('Я потратил 1000', "Ты потратил 134.23 рублей"),
    ('1000 тенге', "Ты потратил 134.23 рублей"),
    ('1000', "Ты потратил 134.23 рублей"),
